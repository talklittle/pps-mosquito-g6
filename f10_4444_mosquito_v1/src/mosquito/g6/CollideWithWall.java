...
public class CollideWithWall {
	...
	public static boolean isCollideWithWall(HelperLight first, HelperLight next, Set<Line2D> walls){
	...
	public static boolean isCollideWithWall(HelperLight point, Set<Line2D> walls){
